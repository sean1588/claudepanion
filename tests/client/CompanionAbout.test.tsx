...
beforeEach(() => {
  vi.stubGlobal("fetch", vi.fn(async (url: string) => {
    if (url === "/api/companions") return new Response(JSON.stringify([
      { name: "demo", kind: "ui", displayName: "Demo", icon: "✨", description: "Demo companion.", contractVersion: "2", version: "0.1.0", requiredEnv: ["DEMO_TOKEN"] },
    ]), { status: 200 });
    ...
    if (url === "/api/tools/demo") return new Response(JSON.stringify({
      manifest: { name: "demo", kind: "ui", displayName: "Demo", icon: "✨", description: "Demo companion.", contractVersion: "2", version: "0.1.0" },
      tools: [
...
describe("CompanionAbout", () => {
  ...
  it("does NOT show write warning when no write tools", async () => {
    vi.stubGlobal("fetch", vi.fn(async (url: string) => {
      if (url === "/api/companions") return new Response(JSON.stringify([
        { name: "ro", kind: "ui", displayName: "RO", icon: "🔍", description: "", contractVersion: "2", version: "0.1.0" },
      ]), { status: 200 });
      ...
      if (url === "/api/tools/ro") return new Response(JSON.stringify({
        manifest: { name: "ro", kind: "ui", displayName: "RO", icon: "🔍", description: "", contractVersion: "2", version: "0.1.0" },
